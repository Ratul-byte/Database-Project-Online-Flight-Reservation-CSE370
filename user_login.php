...
<body>
    ...
    <div class="login-container">
        <h2 style="color: #FFFFF0; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">Log In</h2>
        <form class="login-form" method="post">
            ...
            <b>Don't have an account? </b><a href="register.php"><i class="fa fa-user-plus" aria-hidden="true"></i>Sign Up Now</a>
            <?php
        if (isset($loginError)) {
            echo "<p style='color:#FFFFF0;'>$loginError</p>";
        }
        ?>
        </form>
    </div>
