...
<head>
    ...
    <title>Flight Schedules | Admin</title>
    <style>
    ...
    <section class="content">
        <div class="flight-table">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td><b>Flight Number:</b><br>" . $row['flight_no'] . "</td>";
                echo "<td><b>Aircraft ID:</b><br>" . $row['aircraft_id'] . "</td>";
                echo "<td><b>Arrival City:</b><br>" . $row['arrival_city'] . "</td>";
                echo "<td><b>Arrival Date-Time:</b><br>" . $row['arrival_datetime'] . "</td>";
                echo "<td><b>Departure City:</b><br>" . $row['departure_city'] . "</td>";
                echo "<td><b>Departure Date-Time:</b><br>" . $row['departure_datetime'] . "</td>";
                echo "<td><b>Economy Seats Available:</b><br>" . $row['eco_seats'] . "</td>";
                echo "<td><b>Economy Seats Price:</b><br>$" . $row['eco_price'] . "</td>";
                echo "<td><b>Business Seats Available:</b><br>" . $row['bus_seats'] . "</td>";
                echo "<td><b>Business Seats Price:</b><br>$" . $row['bus_price'] . "</td>";
                echo "</tr>";
